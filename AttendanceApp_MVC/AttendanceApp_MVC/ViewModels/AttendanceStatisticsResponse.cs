...
public class AttendanceStatisticsResponse
{
    ...
    public List<AttendanceStatisticsResponse> Top5RecentlyCheckedInUsers { get; set; } = new List<AttendanceStatisticsResponse>();
    public List<AttendanceStatisticsResponse> TotalAttendanceForCurrentYear { get; set; } = new List<AttendanceStatisticsResponse>();
    public AttendanceStatistics Statistics { get; set; } 
    public List<AttendanceStatisticsResponse> AttendanceWithIssues { get; set; } 
